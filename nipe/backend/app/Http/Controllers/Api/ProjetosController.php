...
use App\Models\Projetos as Model; // 'App\Models\nome_classe'
...
class ProjetosController extends Controller { 
	...
	public $nomeClasse = 'Projetos'; 
	public $muitosParaMuitos = ['alunos'];
	...
	public function relacionamento($classe, $tabela){
		...
		if($tabela == 'unidades')
			return $classe->unidades();

		if($tabela == 'area_conhecimento')
			return $classe->area_conhecimento();
	}
